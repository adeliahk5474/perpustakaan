    ...
    <div class="flex items-center justify-between px-6 h-16">
        ...
        <div class="flex items-center gap-3">
            <div class="relative">
                ...
                <input placeholder="Search resources..." class="pl-8 pr-4 py-2 border border-gray-300 rounded-lg text-sm w-52 focus:outline-none focus:ring-1 focus:ring-[#1B2A5E]">
            </div>
