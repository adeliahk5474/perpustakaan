    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-sm leading-relaxed">Menghubungkan pikiran dengan pengetahuan melalui manajemen digital yang mulus dan arsip fisik yang terkurasi.</p>
            </div>
            <div>
                <h4 class="text-white font-semibold mb-3">Tautan Cepat</h4>
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white">Peraturan Perpustakaan</a></li>
                    <li><a href="#" class="hover:text-white">Peta Situs</a></li>
            ...
            <div>
                ...
                <p class="text-sm">Perpustakaan Pusat Universitas</p>
                <p class="text-sm">Digital Plaza, Lantai 2</p>
