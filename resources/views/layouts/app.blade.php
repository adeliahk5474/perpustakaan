...
<head>
    ...
    <title>@yield('title', 'PerpusKu') — Library Management System</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        navy: { DEFAULT: '#1B2A5E', dark: '#0F1D45', light: '#2D3E7B' },
                    }
                }
            }
        }
    ...
    <style>
        ...
        .status-available { @apply bg-green-100 text-green-700 text-xs font-bold px-2 py-0.5 rounded-full; }
        .status-borrowed  { @apply bg-red-100 text-red-600 text-xs font-bold px-2 py-0.5 rounded-full; }
        .status-overdue   { @apply bg-orange-100 text-orange-700 text-xs font-bold px-2 py-0.5 rounded-full; }
        .status-returned  { @apply bg-blue-100 text-blue-700 text-xs font-bold px-2 py-0.5 rounded-full; }
        .status-ebook     { @apply bg-blue-100 text-blue-700 text-xs font-bold px-2 py-0.5 rounded-full; }
    </style>
    @stack('styles')
</head>
...
<footer class="bg-gray-800 text-gray-400 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-white font-bold text-lg mb-2">PerpusKu</h3>
                <p class="text-sm leading-relaxed">Connecting minds with knowledge through seamless digital management and curated physical archives.</p>
            </div>
            <div>
                <h4 class="text-white font-semibold mb-3">Quick Links</h4>
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white">Library Rules</a></li>
            ...
            <div>
                ...
                <p class="text-sm">University Central Library</p>
                <p class="text-sm">Digital Plaza, Floor 2</p>
                <p class="text-sm">support@perpusku.edu</p>
            </div>
        </div>
        <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm">
            © 2024 PerpusKu Library Management System. All rights reserved.
        </div>
    </div>
</footer>
