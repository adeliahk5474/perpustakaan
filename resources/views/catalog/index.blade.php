...
<div class="relative h-72 bg-cover bg-center overflow-hidden"
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
        <h1 class="text-4xl font-bold mb-2">Jelajahi Dunia Pengetahuan</h1>
        <p class="text-gray-200 mb-6">Akses lebih dari {{ number_format($totalBooks) }} sumber daya digital dan fisik dari arsip kami yang terkurasi.</p>
    ...
    <div class="flex gap-8">
        ...
        <aside class="w-56 flex-shrink-0">
            <div class="bg-white rounded-2xl border border-gray-200 p-5 sticky top-20">
                <h2 class="font-bold text-[#1B2A5E] text-lg mb-4">Filter</h2>
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center mb-5">
                <p class="text-sm text-gray-600">Menampilkan {{ $books->firstItem() }}–{{ $books->lastItem() }} dari {{ number_format($books->total()) }} hasil</p>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-md transition group">
                    <a href="{{ route('books.show', $book) }}" class="block relative">
                        ...
                        <div class="absolute top-2 left-2">
                            ...
                            <span class="bg-green-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">TERSEDIA</span>
                            @else
