...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <nav class="text-sm text-gray-500 mb-6">
        <a href="{{ route('catalog.index') }}" class="hover:text-[#1B2A5E]">Beranda</a>
        <span class="mx-2">›</span>
        <a href="{{ route('catalog.index') }}" class="hover:text-[#1B2A5E]">Katalog</a>
        <span class="mx-2">›</span>
    ...
    <div class="mt-12">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-[#1B2A5E]">Terkait dalam {{ $book->category }}</h2>
            <a href="{{ route('catalog.index', ['category' => $book->category]) }}" class="text-sm text-[#1B2A5E] hover:underline font-semibold">LIHAT SEMUA →</a>
        </div>
