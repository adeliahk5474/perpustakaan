...
<head>
    ...
    <title>Create Account — PerpusKu</title>
...
<header class="p-4 flex justify-between items-center">
    ...
    <a href="{{ route('login') }}" class="bg-[#1B2A5E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-[#0F1D45]">Sign In</a>
</header>

<div class="flex-1 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <h1 class="text-3xl font-bold text-gray-900 text-center">Create an Account</h1>
        <p class="text-gray-500 text-sm text-center mt-2 mb-6">Join our library community to explore thousands of resources.</p>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Student/Member ID</label>
                <div class="relative">
                    <span class="absolute left-3 top-3 text-gray-400">🪪</span>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Password</label>
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-400">🔒</span>
                ...
                <div>
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Confirm</label>
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-400">🔐</span>
            ...
            <div class="flex items-start gap-3 pt-1">
                ...
                <label for="terms" class="text-sm text-gray-600">
                    I agree to the <a href="#" class="text-[#1B2A5E] font-medium hover:underline">Terms of Service</a>
                    and <a href="#" class="text-[#1B2A5E] font-medium hover:underline">Privacy Policy</a> of PerpusKu.
                </label>
            </div>
            ...
            <p class="text-center text-sm text-gray-500 pt-2">
                ...
                <a href="{{ route('login') }}" class="text-[#1B2A5E] font-medium hover:underline">Sign In here</a>
            </p>
        </form>
    </div>
</div>
...
<footer class="bg-gray-800 text-gray-400 py-6 mt-6">
    <div class="max-w-6xl mx-auto px-8 grid grid-cols-4 gap-8 text-sm">
        <div>
            ...
            <p>Digitalizing the heritage of knowledge through modern accessibility and reliable archival systems.</p>
        </div>
        <div>
            <p class="text-white font-semibold mb-2 uppercase text-xs tracking-wider">Resources</p>
            <ul class="space-y-1"><li><a href="#" class="hover:text-white">Library Rules</a></li><li><a href="#" class="hover:text-white">Sitemap</a></li><li><a href="#" class="hover:text-white">Help Center</a></li></ul>
        </div>
        <div>
            <p class="text-white font-semibold mb-2 uppercase text-xs tracking-wider">Legal</p>
            <ul class="space-y-1"><li><a href="#" class="hover:text-white">Privacy Policy</a></li><li><a href="#" class="hover:text-white">Terms of Service</a></li></ul>
        </div>
        <div>
            <p class="text-white font-semibold mb-2 uppercase text-xs tracking-wider">Contact</p>
            <p>Contact Us</p><p>support@perpusku.edu</p>
        </div>
    </div>
    <div class="text-center mt-6 text-xs">© 2024 PerpusKu Library Management System. All rights reserved.</div>
</footer>
</body>
</html>
