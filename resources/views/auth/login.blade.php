...
<body class="min-h-screen bg-gradient-to-br from-[#EEF2FF] to-[#DBEAFE] flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-gray-500 text-sm mt-1">Manajemen Akses Perpustakaan Terpadu</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <p class="text-xs text-gray-400 uppercase tracking-wider text-center mb-2">Mode Simulasi Login</p>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Email atau Username</label>
                        <div class="relative">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <a href="#" class="text-xs text-[#1B2A5E] hover:underline">Lupa kata sandi?</a>
                        </div>
                        <div class="relative">
                            <span class="absolute left-3 top-3 text-gray-400">🔒</span>
                    ...
                    <p class="text-center text-sm text-gray-500">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="text-[#1B2A5E] font-medium hover:underline">Daftar Keanggotaan Perpustakaan</a>
                    </p>
                </form>
            </div>
    ...
    <footer class="bg-gray-800 text-gray-400 py-4 text-center text-xs">
        <div class="flex justify-between px-8">
            <span>© 2024 Sistem Manajemen Perpustakaan PerpusKu. Hak cipta dilindungi.</span>
            <span class="space-x-4">
                <a href="#" class="hover:text-white">Kebijakan Privasi</a>
                <a href="#" class="hover:text-white">Syarat Layanan</a>
                <a href="#" class="hover:text-white">Pusat Bantuan</a>
                <a href="#" class="hover:text-white">Peraturan Perpustakaan</a>
            </span>
        </div>
    </footer>
