...
<div>
    ...
    <div class="grid grid-cols-3 gap-4 mt-6">
        <div class="bg-white border border-gray-200 rounded-2xl p-5">
            ...
            <p class="text-xs text-gray-400 uppercase tracking-wide mt-3">Total Collection</p>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-5">
            <div class="flex justify-between items-start">
                ...
                <span class="text-xs text-gray-400 font-semibold">Active</span>
            </div>
            <p class="text-xs text-gray-400 uppercase tracking-wide mt-3">Active Loans</p>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-5">
            ...
            <p class="text-xs text-gray-400 uppercase tracking-wide mt-3">New Members (Month)</p>
    ...
    <div class="grid grid-cols-3 gap-4 mt-4">
        ...
        <div class="col-span-2 bg-white border border-gray-200 rounded-2xl p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="font-bold text-gray-900">Circulation Trends</h2>
                <span class="text-xs bg-gray-100 px-3 py-1 rounded-full text-gray-500">Last 7 Days</span>
            </div>
            @php
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6">
            <h2 class="font-bold text-gray-900 mb-4">System Health</h2>
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-3 p-3 {{ $overdueAlerts > 0 ? 'bg-orange-50' : 'bg-gray-50' }} rounded-xl">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-gray-800">{{ $overdueAlerts }} Overdue Alerts</p>
                        <p class="text-xs text-gray-500">{{ $overdueAlerts > 0 ? 'Requires notification' : 'All clear' }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <span class="text-xl">💾</span>
                    <div>
                        <p class="text-sm font-semibold text-gray-800">Backup Completed</p>
                        <p class="text-xs text-gray-500">Today, 02:00 AM</p>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl mt-4">
        <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100">
            <h2 class="font-bold text-gray-900">Recent Activities</h2>
            <a href="{{ route('admin.loans') }}" class="text-sm text-[#1B2A5E] hover:underline font-semibold">View All</a>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="text-xs text-gray-400 uppercase tracking-wide border-b border-gray-100">
                        ...
                        <th class="text-left px-6 py-3 font-medium">Book Title</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-500">{{ $loan->created_at->format('M d, Y') }}</td>
                        <td class="px-6 py-4">
