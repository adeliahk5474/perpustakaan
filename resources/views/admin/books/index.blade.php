...
<form action="{{ route('admin.books') }}" method="GET" class="flex gap-3 mb-5">
    <div class="relative flex-1 max-w-sm">
        ...
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Search title, author, ISBN..."
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="bg-gray-50 text-xs text-gray-500 uppercase tracking-wide border-b border-gray-200">
                <th class="text-left px-6 py-3 font-medium">Book</th>
                <th class="text-left px-6 py-3 font-medium">Category</th>
                <th class="text-left px-6 py-3 font-medium">ISBN</th>
                <th class="text-center px-6 py-3 font-medium">Copies</th>
                <th class="text-center px-6 py-3 font-medium">Available</th>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center gap-2 justify-end">
                        <a href="{{ route('admin.books.edit', $book) }}" class="text-xs text-[#1B2A5E] hover:underline font-semibold">Edit</a>
